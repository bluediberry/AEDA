...
bool Empresa::registar_CampoTenis(){
	...
	cout<<"Esta a�ao por si s� nao faz nada. Dever� acrescentar um dia de funcionamento."<<endl;
	return true;
}
...
bool Empresa::r_Utente(){
	...
	cout<<endl<<"Nivel: ";
	cin>>nivel;
	cout<<endl<<"Pretende aderir ao cart�o gold com um custo fixo mensal de "<< cartao_gold_preco << "� que permite o acesso a aulas com 15% desconto?"<<endl;
	cout<<"0. N�o, obrigada!		1. Sim, quero!"<<endl;
	cin>>cartao;
